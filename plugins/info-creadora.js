...
correo = official[0][0] == String(contact[0]) ? 'yallico2024@gamil.com' : official[1][0] == String(contact[0]) ? 'yallico2024@gmail.com' : official[2][0] == String(contact[0]) ? 'yallico2024@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com' : official[1][0] == String(contact[0]) ? 'https://github.com' : official[2][0] == String(contact[0]) ? 'https://github.com' : official[3][0] == String(contact[0]) ? 'https://github.com' : md 
...
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'yallico2024@gmail.com' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 / @𝘠𝘢𝘭𝘭𝘪𝘤𝘰.𝘖𝘸𝘯𝘦𝘳 ⚡︎', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
