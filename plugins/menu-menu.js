...
`╭━〔 *♦️ Nethro Creador ♦️* 〕
*┃➤ Creador : Nethro*
*┃➤ Instagram :* https://www.instagram.com/nethro.gaming
*┃➤ Activo : ${uptime}*
 ╰━━━━━━━━━━━━━
 ...
 *┃➤* _${usedPrefix}velocidad_
  ╰━━━━━━━━━━━━━
   ...
   ╭━〔 *♦️ Nethro Live / Cuentas ♦️* 〕
 *┃➤* _${usedPrefix}LiveTikTok / livetiktok_
 *┃➤* _${usedPrefix}LiveYt / liveyt_
  ╰━━━━━━━━━━━━━
  
  ╭━〔 *♦️ Nethro Free Fire ♦️* 〕
 ...
 *┃➤* _${usedPrefix}cs *:* cs2_
  ...
  ╭━〔 *♦️ Nethro Stickers 2 ♦️* 〕
 *┃➤* _${usedPrefix}wm *packname|author*_
 *┃➤* _${usedPrefix}wm *texto1|texto2*_
  ╰━━━━━━━━━━━━━
  
  ╭━〔 *♦️ Nethro Stickers 3♦️* 〕
 ...
 *┃➤* _${usedPrefix}añadircoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, m, fakeChannel, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 / @𝘠𝘢𝘭𝘭𝘪𝘤𝘰.𝘖𝘸𝘯𝘦𝘳 ⚡︎', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu }}})
